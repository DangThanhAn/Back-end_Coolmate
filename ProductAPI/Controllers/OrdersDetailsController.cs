...
namespace ProductAPI.Controllers
{
    ...
    public class OrdersDetailsController : ControllerBase
    {
        ...
        public OrdersDetailsController(CoolmateContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrdersDetail>> PostOrdersDetail(OrdersDetail ordersDetail)
        {
          if (_context.OrdersDetails == null)
          {
              return Problem("Entity set 'CoolmateContext.OrdersDetails'  is null.");
          }
        ...
        {
            return (_context.OrdersDetails?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
